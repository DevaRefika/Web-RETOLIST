...
<br>
<br>
<a href="<?php echo base_url().'index.php/Admin2/PengajuanCatatan'?>">
<button type="button" class="btn btn-outline-danger">Pengajuan Catatan</button></a>
<a href="<?php echo base_url().'index.php/Admin2/Mahasiswa'?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($chart['file_tugas'])) : ?>
                                    <a href="<?= base_url('assets/pdf/' . $chart['file_tugas']) ?>" download="<?= $chart['file'] ?>">
                            ...
                            <td>
                            <a href="<?php echo base_url().'index.php/Admin2/acceptTugas/'.$chart['id_pengajuantugas']; ?>">
                            <button type="button" class="btn btn-success">Accept</button>
                                </a>
                                <a href="<?php echo base_url().'index.php/Admin2/rejectTugas/'.$chart['id_pengajuantugas']; ?>">
