...
<html lang="en">
  <head>
    <title>Eksplorasi Geofisika</title>
    <meta charset="utf-8">
  ...
  <div class="main-section">
	    ...
	    <div class="container">
	      <a class="navbar-brand" href="index.html">EKSPLORASI GEOFISIKA</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta"><a href="<?php echo base_url().'index.php/Geofisika/Logout'?>" class="nav-link icon d-flex align-items-center"><i class="ion-ios-cloud-download mr-2"></i> Logout</a></li>
	        </ul>
	      </div>
		  </div>
	  </nav>
...
<div class="form-check d-flex justify">
  <a href="<?php echo base_url().'index.php/Geofisika/PengajuanCatatan'?>">
                            <button type="button" class="btn btn-outline-danger mr-2 ml-2">Pengajuan</button></a>
                            <a href="<?php echo base_url().'index.php/Geofisika/Landpage'?>">
